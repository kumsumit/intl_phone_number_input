...
import 'package:fluent_ui/fluent_ui.dart'; // Changed from macos_ui
...
import 'package:intl_phone_number_input/src/widgets/fluent/selector_button.dart';
import 'package:intl_phone_number_input/src/widgets/fluent/input_widget_view.dart';
...
class FluentInternationalPhoneNumber extends StatefulWidget {
  ...
  const FluentInternationalPhoneNumber({
    super.key,
  ...
  @override
  State<FluentInternationalPhoneNumber> createState() =>
      FluentInternationalPhoneNumberState();
}

class FluentInternationalPhoneNumberState
    extends State<FluentInternationalPhoneNumber> {
