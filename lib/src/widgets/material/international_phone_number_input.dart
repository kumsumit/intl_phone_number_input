...
class MaterialInternationalPhoneNumber extends StatefulWidget {
  ...
  @override
  State<MaterialInternationalPhoneNumber> createState() =>
      MaterialInternationalPhoneNumberState();
}

class MaterialInternationalPhoneNumberState
    extends State<MaterialInternationalPhoneNumber> {
  ...
  // A controller edit can cause both the listener and TextFormField validator
  // to run. Keep the metadata-pattern result for that exact input so a single
  // keystroke is parsed only once.
  ...
  @override
  void didUpdateWidget(covariant MaterialInternationalPhoneNumber oldWidget) {
