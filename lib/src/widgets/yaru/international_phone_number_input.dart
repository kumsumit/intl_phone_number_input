...
class YaruInternationalPhoneNumber extends StatefulWidget {
  ...
  @override
  State<YaruInternationalPhoneNumber> createState() =>
      YaruInternationalPhoneNumberState();
}

class YaruInternationalPhoneNumberState
    extends State<YaruInternationalPhoneNumber> {
        ...
        YaruInputWidgetView(
          ...
          decoration:
              widget.inputDecoration?.copyWith(
                hintText: widget.inputDecoration?.hintText ?? hintText,
              ) ??
              InputDecoration(
                label: widget.label,
                hintText: hintText,
  ...
  @override
  void didUpdateWidget(covariant YaruInternationalPhoneNumber oldWidget) {
