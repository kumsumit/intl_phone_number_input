...
class YaruCountrySearchListWidget extends StatefulWidget {
  ...
  const YaruCountrySearchListWidget(
    this.countries, {
    super.key,
  ...
  @override
  State<YaruCountrySearchListWidget> createState() =>
      _YaruCountrySearchListWidgetState();
}

class _YaruCountrySearchListWidgetState
    extends State<YaruCountrySearchListWidget> {
  ...
  @override
  void didUpdateWidget(covariant YaruCountrySearchListWidget oldWidget) {
        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: widget.searchPlaceholder ?? widget.searchHintText,
              // Yaru usually uses a subtle border for search fields
              ...
              ? Center(
                  child: Padding(
                    ...
                    child: Text(
                      ...
                      style: widget.subtitleStyle ?? theme.textTheme.bodySmall,
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                        country.dialCode,
                        style:
                            widget.subtitleStyle ?? theme.textTheme.bodySmall,
                      ),
                    );
                  },
                ),
