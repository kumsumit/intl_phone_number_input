...
class ExampleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return macos.MacosApp(
      ...
      title: 'Intl Phone Number Input - MacOS',
...
class _ExampleHomePageState extends State<ExampleHomePage> {
  ...
  Widget build(BuildContext context) {
    return macos.MacosScaffold(
      toolBar: macos.ToolBar(
        title: const Text('Phone Input Playground - MacOS'),
        titleWidth: 300,
      ),
      children: [
        macos.ContentArea(
          builder: (context, scrollController) => ListView(
            ...
            children: [
              Text(
                ...
                style: macos.MacosTheme.of(context).typography.largeTitle,
              ),
  ...
  List<Widget> _buildControlsChildren(BuildContext context) {
    final theme = macos.MacosTheme.of(context);
    ...
    return [
      ...
      RadioGroup<PhoneInputSelectorType>(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const CupertinoRadio<PhoneInputSelectorType>(
      ...
      RadioGroup<CountryDetectionMode>(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const CupertinoRadio<CountryDetectionMode>(
      ...
      RadioGroup<DetectedCountryOrderStrategy>(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const CupertinoRadio<DetectedCountryOrderStrategy>(
      ...
      Form(
        key: _formKey,
        child: MacosInternationalPhoneNumber(
          key: ValueKey(
          ...
          selectorConfig: SelectorConfig(
            ...
            subtitleStyle: theme.typography.caption1,
          ),
          ...
          onSaved: (number) {
            macos.showMacosAlertDialog(
              context: context,
              builder: (context) => macos.MacosAlertDialog(
                appIcon: const FlutterLogo(size: 56),
                title: const Text('Saved'),
                message: Text('Saved ${number.international}'),
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Live State', style: theme.typography.headline),
            const SizedBox(height: 12),
            ...
            if (_detectedCountryResult != null &&
              ...
              const SizedBox(height: 16),
              Text('Top Ranked Votes', style: theme.typography.subheadline),
              const SizedBox(height: 8),
